...
import * as sm from './v2-sort-mapping.js';
...
export const sortByReleaseDate = (data: types.Card[]): types.Card[] => {
  return data.sort((a, b) => {
...
export function sortByDex(data: types.Card[]): types.Card[] {
  return data.sort((a, b) => {
...
export const sortByEnergy = (data: types.Card[]): types.Card[] => {
  return data.sort((a, b) => {
...
export const sortByRarity = (data: types.Card[]): types.Card[] => {
  return data.sort((a, b) => {
...
export const sortBySubtype = (data: types.Card[]): types.Card[] => {
  return data.sort((a, b) => {
...
export const sortBySupertype = (data: types.Card[]): types.Card[] => {
  return data.sort((a, b) => {
...
export async function sortCards() {
  ...
  const sortBy = (utils.getElByIdOrThrow('sort-dropdown') as HTMLSelectElement)
    .value;
